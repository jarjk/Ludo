...
void out()
{
    ...
    std::cout << "\n\nknockouts:\n";
    std::cout << "\tblue:\t" << blue.knock_out_num << "\n\tred:\t" << red.knock_out_num << "\n\tgreen:\t" << green.knock_out_num << "\n\tyellow:\t" << yellow.knock_out_num << std::endl;
}
...
bool end()
{
    ...
    {
        wait_term();
        std::cout << "Hooray! Everyone throw a six! This means everyone has won!\n";
        exit(0);
        return 0;
    }
...
bool not_empty_five(bool array[5])
{
    if (array[0] == true || array[1] == true || array[2] == true || array[3] == true || array[4] == true)
        return true;
    else
        return false;
}
