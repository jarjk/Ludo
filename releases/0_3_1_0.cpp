 ...
 * display stuff in the way people like it. It's very basic yet, but today:
 * 2023-04-18 it will be enough. yeah, since then i patchid it a bit(2023-04-21)
 * and its code is also a lot better thanks to clangd, which I can actually use
 * now inside of n/lvim and it's pretty awesome. I was trying to make it work
 * for more weeks for about 24 hours all in all, and this was the solution: sudo
 * apt install libstdc++-12-dev . now it works and i'm happy for it. in the next
 * few versions i'll make the pretty_out look even better I think, and also use
 * CLion which has every freakin shit inside of it which helps me to make this
 * code look better, but it's not bad at all. I have functions for most of the
 * stuff which is pretty great. But unfortunately the output is huge and it
...
void pretty_out() {
    ...
    std::cout << fill(2, true, "") << print_wroom(red, 0, true)
              ...
              << fill(2, true, "") << "\n";
    // 3: 2/2
    std::cout << fill(2, true, "") << print_wroom(red, 0, false)
              << print_wroom(red, 1, false) << fill(2, true, "")
              << print_board(21, false) << print_wboard(green, 1, false)
              << print_board(27, false) << fill(2, true, "")
              << print_wroom(green, 0, false) << print_wroom(green, 1, false)
              << fill(2, true, "") << "\n\n";
    ...
    std::cout << fill(2, true, "") << print_wroom(red, 2, true)
              ...
              << fill(2, true, "") << "\n";
    // 4: 2/2
    std::cout << fill(2, true, "") << print_wroom(red, 2, false)
              << print_wroom(red, 3, false) << fill(2, true, "")
              << print_board(20, false) << print_wboard(green, 2, false)
              << print_board(28, false) << fill(2, true, "")
              << print_wroom(green, 2, false) << print_wroom(green, 3, false)
              << fill(2, true, "") << "\n\n";
    ...
    std::cout << fill(2, true, "") << print_wroom(blue, 0, true)
              ...
              << fill(2, true, "") << "\n";
    // 12: 2/2
    std::cout << fill(2, true, "") << print_wroom(blue, 0, false)
              << print_wroom(blue, 1, false) << fill(2, true, "")
              << print_board(2, false) << print_wboard(blue, 2, false)
              << print_board(46, false) << fill(2, true, "")
              << print_wroom(yellow, 0, false) << print_wroom(yellow, 1, false)
              << fill(2, true, "") << "\n\n";
    ...
    std::cout << fill(2, true, "") << print_wroom(blue, 2, true)
              ...
              << fill(2, true, "") << "\n";
    // 13: 2/2
    std::cout << fill(2, true, "") << print_wroom(blue, 2, false)
              << print_wroom(blue, 3, false) << fill(2, true, "")
              << print_board(1, false) << print_wboard(blue, 1, false)
              << print_board(47, false) << fill(2, true, "")
              << print_wroom(yellow, 2, false) << print_wroom(yellow, 3, false)
              << fill(2, true, "") << "\n\n";
