 ...
 * Although it would be nice to know whether it works
 ...
 * The pretty_out is now capable of printing houses. Not so beautiful but okay.
 */
...
struct colour {
    ...
    int colour_num{};
    // how should the figures look like on the board could be different for all
    // of them std::string show_as;
};
...
void pretty_out() {
    ...
    std::cout << print_board(12) << print_board(13) << print_board(14)
              ...
              << print_house(red, 0) << print_house(green, 0)
              << print_house(green, 1) << print_house(green, 2)
              << print_house(green, 3) << print_house(yellow, 0)
              << /* fill(2, true, "") << */ print_board(31) << print_board(32)
    ...
    std::cout << print_house(red, 1) << print_house(red, 2) << fill(1, true, "")
              << print_house(yellow, 1)
              << print_house(yellow, 2) /* << fill(2, true, "") */;
    for (int i = 5 - 1; i >= 0; i--) {
    ...
    // 9: 1/2
    std::cout
        << print_board(10) << print_board(9) << print_board(8) << print_board(7)
        << print_board(6) << print_board(5) << print_house(red, 3)
        << print_house(blue, 0) << print_house(blue, 1) << print_house(blue, 2)
        << print_house(blue, 3)
        << print_house(yellow, 3) /* << fill(3, true, "") */ << print_board(43)
        << print_board(42) << print_board(41) << print_board(40)
        << print_board(39) << print_board(38) << "\n\n";
